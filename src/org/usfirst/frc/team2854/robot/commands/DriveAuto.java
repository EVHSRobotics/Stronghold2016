...
public class DriveAuto extends Command {
    ...
    protected void execute() {
    	...
    	SmartDashboard.putNumber("Encoder Left Drive Value", RMap.encoderDriveLeft.getRaw());
    	SmartDashboard.putNumber("Encoder Right Drive Value", RMap.encoderDriveRight.getRaw());
